...
import TableBodyDummyLanguage from "../../components/language/table/TableBodyDummyLanguage";
    ...
    <Box sx={{ m: 2 }}>
      <Box component={"article"}>
        <Container maxWidth="xl">
          ...
          >
            <Typography variant="h4">فهرست دوره‌های زبان انگلیسی</Typography>
          </Box>
