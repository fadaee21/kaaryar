    ...
    <Container maxWidth="xl">
      <header>
        <Stack direction="row" sx={{ alignItems: "flex-start" }}>
          <Stack sx={{ mr: "auto" }}>
          <Typography variant="h6">{`فهرست دوره‌های تخصصی > ${data?.name} >  منتور های فعال این دوره`}</Typography>
          </Stack>
          <Button
            variant="outlined"
            sx={{ px: 5 }}
...
export default CoreModuleCourseMentor;
