...
import WorkshopsDetailComp from "../../../components/generalCourse/GeneralDetailComp";
    ...
    <Container maxWidth="lg">
      <header>
        <Stack direction="row" sx={{ alignItems: "flex-start" }}>
          <Stack sx={{ mr: "auto" }}>
            <Typography variant="h6">{`فهرست دوره‌های عمومی > زبان انگلیسی > ${data?.name}`}</Typography>
      ...
      <WorkshopsDetailComp workshopDetail={data} />
    </Container>
  );
};
